angular.module('OtherGameCtrl', []).
    controller('OtherGameController', function($scope, $routeParams, cssInjector) {
    ...
    function initGame() {
        ...
        spriteLoader.load("./assets/othergameproject/img", spriteNames, ".png", function (loadedSprites) {
